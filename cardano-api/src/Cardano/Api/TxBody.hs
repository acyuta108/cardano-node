...
data TxBodyError era =
     ...
     | TxBodyEmptyTxOuts
     | TxBodyOutputNegative Quantity (TxOut CtxTx era)
     | TxBodyOutputOverflow Quantity (TxOut CtxTx era)
      ...
      ByronTxBody $
        reAnnotate $
          Annotated
            ...
            ()
  where
    classifyRangeError :: TxOut CtxTx ByronEra -> TxBodyError ByronEra
    classifyRangeError
